                ...
                <div class="widget-content">
                  ...
                  <div class="padd">
                             ...
                             <div class="support-contact">
                                ...
                                <p><i class="fa fa-phone"></i>&nbsp; Phone<strong>:</strong> 09460524472</p>
                                <hr />
                                <p><i class="fa fa-envelope"></i>&nbsp; Gmail<strong>:</strong> restaurantalton@gmail.com</p>
                                <hr />
                                <p><i class="fa fa-home"></i>&nbsp; Address<strong>:</strong> Brgy.9 Kabankalan City Negros Occidental </p>
                <hr />
        <p><i class="fa fa-facebook"></i>&nbsp; Facebook<strong>:</strong> facebook.com/Alton Restaurant </p>
                <hr />              
                                <!-- Button -->
